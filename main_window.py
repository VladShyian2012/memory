...
gb_answer = QGroupBox()
v1 = QVBoxLayout()
v1.addWidget(lb_result, alignment=Qt.AlignmentFlag.AlignTop | Qt.AlignmentFlag.AlignLeft)
v1.addWidget(lb_right_answer, alignment=Qt.AlignmentFlag.AlignHCenter | Qt.AlignmentFlag.AlignVCenter)
